...
<%@ page import="com.hrz.crm.settings.entity.User" %>
<%
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="position: relative; left: 40px;">
						...
						组织机构：<b><%=user.getDeptno()%> 二级部门</b><br><br>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="settings/qx/index.jsp"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
